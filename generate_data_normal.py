...
for Number_of_clients in The_all_number_of_devices:
    All_clients_dataset_info = np.random.normal(2.0e6, 1.0e7, size = (T_round, Number_of_clients)) # all clien [1, 100]MB
    ...
    savemat("./original_data_1000_"f'{Number_of_clients}'"_normal.mat", {'All_clients_dataset_info' : All_clients_dataset_info, 'All_clients_bandwidth_info': All_clients_bandwidth_info, 'All_clients_transmission_power_info': All_clients_transmission_power_info, 'G':G, 'unit_cost': unit_cost, 'f':f, 'energy_harvesting':energy_harvesting})
