...
All_clients_dataset_info = np.concatenate((All_clients_dataset_info, All_clients_dataset_info_new), axis = 1)
...
All_clients_bandwidth_info = np.concatenate((All_clients_bandwidth_info, All_clients_bandwidth_info_new), axis = 1)


All_clients_transmission_power_info_new = np.random.uniform(0.1, 1.50, size = (T_round, Add_number_of_devices)) # unit dBm
All_clients_transmission_power_info = np.concatenate((All_clients_transmission_power_info, All_clients_transmission_power_info_new), axis = 1)
