...
####################################################################################################
#n_index = 41 # maximum channel  5  9 13 17 21 25 29 33 37 41
n_index = 32 # average channel 16, 20, 24, 28, 32, 36,40, 44, 48,52, 56. K 
...
def plot(rewards):
    ...
    plt.plot(rewards)
    plt.savefig('./results_v8/channel_experiment_results/normal_distribution/td3_lstm_30_6_'f'{n_index}''k.png')
    #plt.show()

#K = 10
#max_episodes = 1000  

datafile = './source_data/channel_experiment/normal_distribution/original_data_1000_30_6_'f'{n_index}''k_normal.mat'
...
model_path = './model/jingjing_td3_lstm_30_6_'f'{n_index}''k'
    ...
    if args.train:
        ...
        for eps in range(max_episodes):
            ...
            if eps % 10 == 0 and eps > 0:
                plot(rewards)
                #np.save('./results_v8/channel_experiment_results/1_'f'{n_index}''/rewards_td3_lstm_30_1_'f'{n_index}', rewards)
                np.save('./results_v8/channel_experiment_results/normal_distribution/rewards_td3_lstm_30_6_'f'{n_index}''k', rewards)
        ...
        #np.save('./results_v8/channel_experiment_results/1_'f'{n_index}''/accuracy_td3_lstm_30_1_'f'{n_index}', fl_accuracy)
        #np.save('./results_v8/channel_experiment_results/1_'f'{n_index}''/energy_td3_lstm_30_1_'f'{n_index}', device_energy_consumption)
        #np.save('./results_v8/channel_experiment_results/1_'f'{n_index}''/select_td3_lstm_30_1_'f'{n_index}', accumulate_select)
        #np.save('./results_v8/channel_experiment_results/1_'f'{n_index}''/penalty_td3_lstm_30_1_'f'{n_index}', fl_penalty)
        #np.save('./results_v8/channel_experiment_results/1_'f'{n_index}''/runtime_td3_lstm_30_1_'f'{n_index}', episode_runtime)

        np.save('./results_v8/channel_experiment_results/normal_distribution/accuracy_td3_lstm_30_6_'f'{n_index}''k', fl_accuracy)
        np.save('./results_v8/channel_experiment_results/normal_distribution/energy_td3_lstm_30_6_'f'{n_index}''k', device_energy_consumption)
        np.save('./results_v8/channel_experiment_results/normal_distribution/penalty_td3_lstm_30_6_'f'{n_index}''k', fl_penalty)
